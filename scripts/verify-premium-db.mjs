...
rejected(authenticated(`select reserve_attachment_upload('image2',null,'${shared}');`, editor), /Pro/);
...
console.log('PASS premium database: migrations, RLS, owner-funded Free editor, upload reservation/revocation, downgrade preservation, quota growth/shrink/concurrency, recovery, stale webhook');
