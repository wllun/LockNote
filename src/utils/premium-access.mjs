...
export const FEATURE_PLANS = Object.freeze({ export: 'plus', sharing: 'plus', attachments: 'pro', backgrounds: 'pro', nesting: 'pro' });
...
export const premiumAccessError = (feature) => {
  const names = { export: 'PDF and image export', sharing: 'Sharing notes', attachments: 'Adding images', backgrounds: 'Changing note backgrounds', nesting: 'Creating or moving nested folders' };
